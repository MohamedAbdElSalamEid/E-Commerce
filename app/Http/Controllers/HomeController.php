...
class HomeController extends BaseController {
    ...
    public function gallary() {
        ...
        return view('site.home.gallary', compact('videoalbums', 'photoalbums'));
    }
    /* -------- About Action ------------- */
    ...
    public function store(ContactFormRequest $request) {
        ...
        \Mail::send('emails.contact', array(
            ...
            $message->from('softengineer7@yahoo.com');
            $message->to('softengineer7@yahoo.com', 'Admin')->subject('Feedback');
        });
